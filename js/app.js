(() => {
    ...
    function initSliders() {
        if (document.querySelector(".presentation-section__slider")) new core(".presentation-section__slider", {
        ...
        if (document.querySelector(".quickit-section__slider")) new core(".quickit-section__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
